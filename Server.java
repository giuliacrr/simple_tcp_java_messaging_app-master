...
public class Server {
    ...
    private static class ClientHandler extends Thread { // Estensione di classe thread, come se creassi un sottoprocesso
        private Socket clientSocket; // Socket del client, attributo
        ...
        @Override
        public void run() {// che è già presente in thread
            try {
